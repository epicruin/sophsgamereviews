          ...
          <div className="p-1.5 sm:p-2 md:p-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                <Heart 
                  className={`w-3 sm:w-3.5 h-3 sm:h-3.5 text-rose-500 ${(likes ?? 0) > 0 ? 'fill-rose-500' : ''}`}
                />
                <span className="text-[8px] sm:text-[10px] md:text-xs font-medium text-white">{likes ?? 0}</span>
              </div>
            </div>
          </div>
        </div>
