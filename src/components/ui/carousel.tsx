...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "absolute h-6 w-6 rounded-full p-0 border border-rose-400 bg-white hidden",
        "text-rose-500 transition-colors duration-150",
        "hover:bg-rose-100 hover:border-rose-500",
        "focus:outline-none focus:ring-0",
        "disabled:opacity-40 disabled:bg-gray-100 disabled:border-gray-300 disabled:text-gray-400",
        orientation === "horizontal"
